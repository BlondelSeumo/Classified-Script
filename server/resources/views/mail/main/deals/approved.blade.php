...
<div style="font-size:1px;line-height:15px"> </div><img align="center" alt="I'm an image" border="0" class="center fixedwidth" src="https://res.cloudinary.com/mendelman/image/upload/v1570816966/undraw_trendy_interface_lg8x_resqvz.svg" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 567px; display: block;" title="I'm an image" width="567"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
<!--[if (!mso)&(!IE)]><!-->
</div>
...
<p style="line-height: 1.2; text-align: center; font-size: 20px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 20px;">YOUR DEAL HAS  BEEN APPROVED</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;">{!! $deal->description !!}</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
