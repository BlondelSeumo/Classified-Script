...
<p style="line-height: 1.2; text-align: center; font-size: 30px; mso-line-height-alt: 36px; margin: 0;"><span style="font-size: 30px;">YOUR SHOP HAS BEEN EXPIRED</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;"><strong>{{ $shop->title }}</strong>, has been expired, For more information please check your </p>
