...
<div style="font-size:1px;line-height:5px"> </div><a href="{{ clientIndex() }}" tabindex="-1" target="_blank"> <img align="center" alt="Logo" border="0" class="center autowidth" src="{{ $logo }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: none; width: 100%; max-width: 320px; display: block;" title="Logo" width="320"/></a>
...
<p style="line-height: 1.2; text-align: center; font-size: 28px; mso-line-height-alt: 34px; margin: 0;"><span style="font-size: 28px;">NEW SHOP PENDING APPROVAL</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; text-align: center; mso-line-height-alt: 21px; margin: 0;">Go to dashboard to approve or delete pending shops</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<div align="center" class="button-container" style="padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:31.5pt; width:157.5pt; v-text-anchor:middle;" arcsize="120%" stroke="false" fillcolor="#6C63FF"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Arial, sans-serif; font-size:16px"><![endif]--><a href="{{ clientIndex('administrator/pending/shops') }}" style="-webkit-text-size-adjust: none; text-decoration: none; display: inline-block; color: #ffffff; background-color: #6C63FF; border-radius: 50px; -webkit-border-radius: 50px; -moz-border-radius: 50px; width: auto; width: auto; border-top: 1px solid #6C63FF; border-right: 1px solid #6C63FF; border-bottom: 1px solid #6C63FF; border-left: 1px solid #6C63FF; padding-top: 5px; padding-bottom: 5px; font-family: 'Open Sans', Helvetica, Arial, sans-serif; text-align: center; mso-border-alt: none; word-break: keep-all;" target="_blank"><span style="padding-left:50px;padding-right:50px;font-size:16px;display:inline-block;">
<span style="font-size: 16px; line-height: 2; mso-line-height-alt: 32px;"><strong>Pending shops</strong></span>
</span></a>
...
@if(!$shop->logo)
<img align="center" alt="{{ $shop->title }}" border="0" class="center autowidth fullwidth" src="{{ index('storage/app/uploads/default/store/no-logo.png') }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 161px; display: block;" title="{{ $shop->title }}" width="161"/>
@else
<img align="center" alt="{{ $shop->title }}" border="0" class="center autowidth fullwidth" src="{{ index('storage/app/' . $shop->logo) }}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 161px; display: block;" title="{{ $shop->title }}" width="161"/>
@endif
