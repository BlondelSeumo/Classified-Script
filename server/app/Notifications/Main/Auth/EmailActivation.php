...
class EmailActivation extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        // Generate link
        $link     = clientIndex("auth/activation?token=$this->token");
        ...
        return (new MailMessage)
                ->subject("['" . config('app.name') . "'] " . __('trans.t_confirm_your_email', [], config('app.locale')))
                ->markdown('mail.main.auth.activation', $data);
    }
