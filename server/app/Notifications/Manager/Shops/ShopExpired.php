...
class ShopExpired extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ->subject("['" . config('app.name') . "'] " . __('trans.t_your_shop_expired', [], config('app.locale')))
                ->markdown('mail.manager.shops.expired', $data);
    }
