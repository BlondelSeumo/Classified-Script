...
class MaintenanceEnabled extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ->subject("['" . config('app.name') . "'] " . __('trans.t_maintenance_enabled', [], config('app.locale')))
                ->markdown('mail.administrator.maintenance.enabled', $data);
    }
