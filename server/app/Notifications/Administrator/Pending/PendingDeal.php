...
class PendingDeal extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                ->subject("['" . config('app.name') . "'] " . __('trans.t_new_deal_pending', [], config('app.locale')))
                ->markdown('mail.administrator.pending.deal', $data);
    }
