								...
								<v-flex xs12 style="width: 100%">
									<v-container grid-list-xl class="pa-0">
										<v-layout row wrap align-start justify-start>
											<!-- Packages --> 
											<v-flex xs3 v-for="(p, index) in packages" :key="index">
												<v-card flat style="box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.08);" class="py-3 cursor-pointer" :color="selected === p.id ? '#878d8b' : 'white'" :class="selected === p.id ? 'selected-package' : ''">
