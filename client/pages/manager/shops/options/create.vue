				...
				<v-container grid-list-xl fluid class="pa-4">
					<v-layout wrap>
						...
						<v-flex xs6 class="mb-3">
							<upload-btn uniqueId :disabled="exceeded" @file-update="logo" block accept="image/*" :title="$t('t_choose_logo')" color="grey lighten-3" class="pa-0"></upload-btn>
						</v-flex>

						<!-- Shop cover -->
						<v-flex xs6 class="mb-3">
							<upload-btn uniqueId :disabled="exceeded" @file-update="cover" block accept="image/*" :title="$t('t_choose_cover')" color="grey lighten-3" class="pa-0"></upload-btn>
						</v-flex>
