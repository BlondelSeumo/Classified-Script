	...
	<v-app id="inspire">
		...
		<v-container grid-list-xl fluid class="pa-4">
			<v-layout wrap class="pl-5 pr-5">
				...
				<!-- Themes -->
				<v-flex xs4 v-for="(theme, name) in themes" :key="name">
					<div class="small-card-item m-card" style="height: 208px;">
				...
				<v-flex xs4>
					<v-tooltip top>
						<template v-slot:activator="{ on }">
							<div v-on="on" class="small-card-item" style="height: 208px; background-color: transparent; text-align: center; border: 2px dashed rgb(218, 218, 220); box-shadow: none;">
								<nuxt-link to="/administrator/themes/request" style="display: block; height: 100%; width: 100%;">
									<i class="mdi mdi-palette" style="color: rgb(209, 209, 212); font-size: 45px; padding-top: 70px; display: block;"></i>
								</nuxt-link>
							</div>
						</template>
