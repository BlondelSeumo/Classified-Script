	...
	<v-app id="inspire">
		<v-container fluid grid-list-xl id="home-stats">
			<v-layout wrap>
				...
				<!-- Users -->
				<v-flex xs3 v-if="$adgate.allow($auth.user, 'access', 'users')">
					<v-card class="m-card" text height="200px">
						<v-sheet class="v-sheet--offset mx-auto text-center" text>
							<v-tooltip top>
								<template v-slot:activator="{ on }">
									<v-icon v-on="on" color="grey darken-3" size="40px" class="pa-3">mdi-account-group</v-icon>
								</template>
								<span>{{ $t('t_users_statistics') }}</span>
							</v-tooltip>
						</v-sheet>
						<v-card-text class="pt-0 text-center">
							<div class="grey--text text--darken-3 display-1 font-weight-black mt-2 text-center">{{ stats.users.counter | numeralFormat }}</div>
						</v-card-text>
						<v-bottom-navigation
							absolute
							...
							<v-btn color="#333333" text @click="stats.users.counter = stats.users.yesterday" class="font-weight-bold text-uppercase">
								{{ $t('t_yesterday') }}
							</v-btn>
				...
				<!-- Deals -->
				<v-flex xs3 v-if="$adgate.allow($auth.user, 'access', 'deals')">
					<v-card class="m-card" text height="200px">
						<v-sheet class="v-sheet--offset mx-auto text-center" text>
							<v-tooltip top>
								<template v-slot:activator="{ on }">
									<v-icon v-on="on" color="grey darken-3" size="40px" class="pa-3">mdi-image-multiple</v-icon>
								</template>
								<span>{{ $t('t_deals_statistics') }}</span>
							</v-tooltip>
						</v-sheet>
						<v-card-text class="pt-0 text-center">
							<div class="grey--text text--darken-3 display-1 font-weight-black mt-2 text-center">{{ stats.deals.counter | numeralFormat }}</div>
						</v-card-text>
						<v-bottom-navigation
							absolute
							background-color="#f9f9f9"
							...
							<v-btn color="#333333" text @click="stats.deals.counter = stats.deals.yesterday" class="font-weight-bold text-uppercase">
								{{ $t('t_yesterday') }}
							</v-btn>
				...
				<!-- Shops -->
				<v-flex xs3 v-if="$adgate.allow($auth.user, 'access', 'shops')">
					<v-card class="m-card" text height="200px">
						<v-sheet class="v-sheet--offset mx-auto text-center" text>
							<v-tooltip top>
								<template v-slot:activator="{ on }">
									<v-icon v-on="on" color="grey darken-3" size="40px" class="pa-3">mdi-store</v-icon>
								</template>
								<span>{{ $t('t_shops_statistics') }}</span>
							</v-tooltip>
						</v-sheet>
						<v-card-text class="pt-0 text-center">
							<div class="grey--text text--darken-3 display-1 font-weight-black mt-2 text-center">{{ stats.shops.counter | numeralFormat }}</div>
						</v-card-text>
						<v-bottom-navigation
							absolute
							background-color="#f9f9f9"
							...
							<v-btn color="#333333" text @click="stats.shops.counter = stats.shops.yesterday" class="font-weight-bold text-uppercase">
								{{ $t('t_yesterday') }}
							</v-btn>
				...
				<!-- Comments -->
				<v-flex xs3 v-if="$adgate.allow($auth.user, 'access', 'comments')">
					<v-card class="m-card" text height="200px">
						<v-sheet class="v-sheet--offset mx-auto text-center" text>
							<v-tooltip top>
								<template v-slot:activator="{ on }">
									<v-icon v-on="on" color="grey darken-3" size="40px" class="pa-3">mdi-comment-text-multiple</v-icon>
								</template>
								<span>{{ $t('t_comments_statistics') }}</span>
							</v-tooltip>
						</v-sheet>
						<v-card-text class="pt-0 text-center">
							<div class="grey--text text--darken-3 display-1 font-weight-black mt-2 text-center">{{ stats.comments.counter | numeralFormat }}</div>
						</v-card-text>
						<v-bottom-navigation
							absolute
							background-color="#f9f9f9"
							...
							<v-btn color="#333333" text @click="stats.comments.counter = stats.comments.yesterday" class="font-weight-bold text-uppercase">
								{{ $t('t_yesterday') }}
							</v-btn>
				...
				<v-flex xs6 v-if="$adgate.allow($auth.user, 'statistics', 'deals')">
					<div class="m-card">
