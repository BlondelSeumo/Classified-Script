...
export default function (ctx, inject) {
  ...
  // facebook
  $auth.registerStrategy('facebook', new scheme_6ce4fcca($auth, {"client_id":"","userinfo_endpoint":"https://graph.facebook.com/v2.12/me?fields=about,name,picture{url},email","redirect_uri":"http://domain.com/auth/facebook/callback","token_key":"access_token","response_type":"token","scope":["public_profile","email"],"_name":"facebook","authorization_endpoint":"https://facebook.com/v2.12/dialog/oauth"}))

  // google
  $auth.registerStrategy('google', new scheme_6ce4fcca($auth, {"client_id":"","redirect_uri":"http://domain.com/auth/google/callback","_name":"google","authorization_endpoint":"https://accounts.google.com/o/oauth2/auth","userinfo_endpoint":"https://www.googleapis.com/oauth2/v3/userinfo","scope":["openid","profile","email"]}))
