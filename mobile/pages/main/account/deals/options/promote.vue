						...
						<v-container grid-list-xl class="pa-0">
							<v-layout row>
								...
								<v-flex xs6 v-for="(p, index) in packages" :key="index">
									<v-card flat style="box-shadow: 0px 1px 1px rgba(0, 0, 0, 0.08);" class="cursor-pointer pt-3" :color="selected === p.id ? '#878d8b' : ($vuetify.theme.dark ? '#3a3939' : 'white')" :class="selected === p.id ? 'selected-package' : ''">
