									...
									<v-row justify="center">
										<v-flex xs10 class="text-center">
											...
											<div v-if="!account.password_security">
												<v-btn block depressed @click.prevent="generate()" :color="$vuetify.theme.dark ? '#606060' : 'grey darken-3'" class="white--text">
											...
											<div v-else-if="!account.password_security.google2fa_enable">
												...
												<!-- Enable -->
												<v-btn block depressed @click.prevent="enable()" :color="$vuetify.theme.dark ? '#606060' : 'grey darken-3'" dark class="mt-4">
													{{ $t('t_enable_2fa') }}
												</v-btn>
											...
											<div v-else>
												...
												<!-- Disable -->
												<v-btn block depressed @click.prevent="disable()" :color="$vuetify.theme.dark ? '#606060' : 'grey darken-3'" class="white--text">
													{{ $t('t_disable_2fa') }}
												</v-btn>
