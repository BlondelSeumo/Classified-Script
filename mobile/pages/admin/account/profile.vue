				...
				<v-container grid-list-xl fluid class="pa-4">
					<v-layout wrap>
						...
						<v-flex xs12 class="text-center mb-4">
	                        ...
	                        <client-only>
		                        <upload-btn @file-update="avatar" accept="image/*" :title="$t('t_change_avatar')" :color="$vuetify.theme.dark ? 'grey darken-4' : 'grey lighten-3'" class="pa-0 text-small"></upload-btn>
		                    </client-only>
						</v-flex>
