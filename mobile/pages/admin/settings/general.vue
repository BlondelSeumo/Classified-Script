			...
			<v-card class="m-card" flat>
				...
				<v-container grid-list-xl fluid class="pa-4">
					<v-layout wrap>
						...
						<v-flex xs4>
							<upload-btn uniqueId @file-update="transparent" block accept="image/*" :title="$t('t_transparent_header_logo')" :color="$vuetify.theme.dark ? 'grey darken-4' : 'grey lighten-3'" class="pa-0"></upload-btn>
						</v-flex>

						<!-- White Header Logo -->
						<v-flex xs4>
							<upload-btn uniqueId @file-update="white" block accept="image/*" :title="$t('t_white_header_logo')" :color="$vuetify.theme.dark ? 'grey darken-4' : 'grey lighten-3'" class="pa-0"></upload-btn>
						</v-flex>

						<!-- Favicon -->
						<v-flex xs4>
							<upload-btn uniqueId @file-update="favicon" block accept="image/*" :title="$t('t_upload_favicon')" :color="$vuetify.theme.dark ? 'grey darken-4' : 'grey lighten-3'" class="pa-0"></upload-btn>
						</v-flex>
