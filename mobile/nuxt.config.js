...
module.exports = {
  ...
  env: {
    ...
    desktopUrl: process.env.DESKTOP_URL,
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'apple-mobile-web-app-status-bar-style', content: '#4285f4' }
    ],
    link: [
  ...
  router: {
    middleware: ['desktop', 'locale']
  },

  css: [
    'swiper/dist/css/swiper.css',
    { src: '~assets/sass/app.scss', lang: 'scss' },
    { src: '~assets/sass/mobile.scss', lang: 'scss' },
  ],
