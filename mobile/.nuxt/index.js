...
import nuxt_plugin_cookieuniversalnuxt_4a8fe765 from 'nuxt_plugin_cookieuniversalnuxt_4a8fe765' // Source: .\\cookie-universal-nuxt.js (mode: 'all')
import nuxt_plugin_recaptcha_03aa6ca8 from 'nuxt_plugin_recaptcha_03aa6ca8' // Source: .\\recaptcha.js (mode: 'all')
import nuxt_plugin_libplugin7ee41d58_5755da2e from 'nuxt_plugin_libplugin7ee41d58_5755da2e' // Source: .\\lib.plugin.7ee41d58.js (mode: 'all')
import nuxt_plugin_toast_9580a328 from 'nuxt_plugin_toast_9580a328' // Source: .\\toast.js (mode: 'client')
import nuxt_plugin_axios_2de13c86 from 'nuxt_plugin_axios_2de13c86' // Source: .\\axios.js (mode: 'all')
import nuxt_plugin_router_25ad3cdc from 'nuxt_plugin_router_25ad3cdc' // Source: .\\router.js (mode: 'all')
...
import nuxt_plugin_plugin_cd2760a8 from 'nuxt_plugin_plugin_cd2760a8' // Source: .\\auth\\plugin.js (mode: 'all')
import nuxt_plugin_auth_7f7561ce from 'nuxt_plugin_auth_7f7561ce' // Source: ..\\plugins\\auth.js (mode: 'all')
import nuxt_plugin_echo_e4233b94 from 'nuxt_plugin_echo_e4233b94' // Source: .\\echo.js (mode: 'client')
...
async function createApp (ssrContext) {
  ...
  if (typeof nuxt_plugin_cookieuniversalnuxt_4a8fe765 === 'function') {
    await nuxt_plugin_cookieuniversalnuxt_4a8fe765(app.context, inject)
  }

  if (typeof nuxt_plugin_recaptcha_03aa6ca8 === 'function') {
    await nuxt_plugin_recaptcha_03aa6ca8(app.context, inject)
  }

  if (typeof nuxt_plugin_libplugin7ee41d58_5755da2e === 'function') {
    await nuxt_plugin_libplugin7ee41d58_5755da2e(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_toast_9580a328 === 'function') {
    await nuxt_plugin_toast_9580a328(app.context, inject)
  }

  if (typeof nuxt_plugin_axios_2de13c86 === 'function') {
    await nuxt_plugin_axios_2de13c86(app.context, inject)
  }

  if (typeof nuxt_plugin_router_25ad3cdc === 'function') {
    await nuxt_plugin_router_25ad3cdc(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_plugin_cd2760a8 === 'function') {
    await nuxt_plugin_plugin_cd2760a8(app.context, inject)
  }
  ...
  if (process.client && typeof nuxt_plugin_echo_e4233b94 === 'function') {
    await nuxt_plugin_echo_e4233b94(app.context, inject)
  }
